...
///
/// DSF is technically a file consisting of chunks, but:
///
/// 1. Compared to [`write_to_chunk_file()`], the chunk name and size are reversed
/// 2. DSF just stores the tag completely differently
