...
use crate::id3::v2::error::{FrameEncodingError, FrameParseError};
...
impl<'a> ChapterTableOfContentsFrame<'a> {
	...
	pub fn as_bytes(
		...
		if version == Id3v2Version::V2 {
			return Err(FrameEncodingError::unsupported_version(version));
		}
...
impl ChapterTableOfContentsFrame<'static> {
	...
	{
		if version == Id3v2Version::V2 {
			return Err(FrameParseError::unsupported_version(version));
		}
